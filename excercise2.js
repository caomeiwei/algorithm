...
for(let i=0;i<matrix.row;i++){
    ...
    max_matrix.push(  new Array(matrix.col).fill(0) );
}
...
function search(){
    ...
    }else if( currvalue > max_matrix[down][right]  ){


        max_matrix[down][right] =  currvalue;
